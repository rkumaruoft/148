...
def test_contains_one() -> None:
    """Test LinkedList.__contains__ for linked list with one node"""
    lst = one_item('a')
    assert 'a' in lst


def test_contains_all() -> None:
    """Test LinkedList.__contains__ for linked list with three node"""
    lst = three_items('a', 1, False)
    assert 'a' and 1 and False in lst


def test_not_contains_one() -> None:
    """Test LinkedList.__contains__ for linked list with one node"""
    lst = one_item('a')
    assert 'b' not in lst
