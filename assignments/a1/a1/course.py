...
class Student:
    ...
    === Private Attributes ===
    _answers : a dict that maps id of a question to this student's answer
...
class Course:
    ...
    === Private Attributes ===
    _student_ids : list of ids of all the students in this course
    === Representation Invariants ===
    ...
    def all_answered(self, survey: Survey) -> bool:
        ...
        for ques in survey.get_questions():
            for student in self.students:
                if not student.has_answer(ques):
                    return False
        return True
